  ...
  return (
    ...
    from-pink-500/10 to-purple-500/10 text-sm text-pink-400 mb-6 shadow-md shadow-pink-500/10"
          ...
          <motion.h1
            ...
            className="text-4xl md:text-5xl font-extrabold bg-gradient-to-r from-white to-gray-300 text-transparent bg-clip-text mb-6 tracking-tight"
          >
            Browse. Steal. Ship Code Faster.
          </motion.h1>
